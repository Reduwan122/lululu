  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.bg }]} edges={['bottom', 'left', 'right']}>
      ...
      <View style={styles.emptyWrap}>
        <Ionicons name="card-outline" size={64} color={colors.greyText} />
        <Text style={[styles.emptyTitle, { color: colors.white }]}>No Driving Licenses</Text>
        <Text style={[styles.emptySub, { color: colors.greyText }]}>
          Once you have a driving license, the details will display here.
        </Text>
      </View>
    </SafeAreaView>
  );
