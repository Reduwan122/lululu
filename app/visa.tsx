  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.bg }]} edges={['bottom', 'left', 'right']}>
      ...
      <View style={styles.emptyWrap}>
        <Ionicons name="document-text-outline" size={64} color={colors.greyText} />
        <Text style={[styles.emptyTitle, { color: colors.white }]}>No Visa</Text>
        <Text style={[styles.emptySub, { color: colors.greyText }]}>
          Once you have a Visa, the details will display here.
        </Text>
      </View>
    </SafeAreaView>
  );
